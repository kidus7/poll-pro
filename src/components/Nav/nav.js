...
const pages = ['HOME', 'QUESTIONS', 'POLLS', 'CATEGORIES'];
...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar position="sticky" sx={{backgroundColor: 'transparent', boxShadow: 'none'}} className="appBar">
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' }, color: 'grey' }}>
            ...
            >
              {pages.map((page) => (
                <MenuItem key={page} >
                  <Typography textAlign="center" component="a" href="/dashboard">{page}</Typography>
                </MenuItem>
              ))}
            </Menu>
          </Box>
          <AdbIcon sx={{ color: 'grey', display: { xs: 'flex', md: 'none', lg: 'none', xl: 'none'}, mr: 1 }} />
          <Typography
            variant="h5"
            noWrap
            component="a"
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="Remy Rat" src="/static/images/avatar/2.jpg" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '35px' }}
